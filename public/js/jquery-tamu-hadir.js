/*! jquery-qrcode v0.17.0 - https://larsjung.de/jquery-qrcode/ */ ! function(t, r) {
    ...
    return function(e) {
        ...
        (function(t) {
            ...
            function n(t, r) {
                ...
                if (!e) return null;
                var n = d(t).data("qrcode", e),
                    o = n[0].getContext("2d");
                return i(e, o, r),
                    function(t, r, e) {
                        var n, o, i = t.module_count,
                            a = e.size / i,
                            u = l;
                        for (0 < e.radius && e.radius <= .5 && (u = g), r.beginPath(), n = 0; n < i; n += 1)
                            for (o = 0; o < i; o += 1) u(t, r, e, e.left + o * a, e.top + n * a, a, n, o);
                        if (c(e.fill)) {
            ...
            function o(t) {
                return f && "canvas" === t.render ? r(t) : f && "image" === t.render ? function(t) {
                    ...
                    for (i && s.css("background-color", i), e = 0; e < u; e += 1)
                        for (n = 0; n < u; n += 1) r.is_dark(e, n) && d("<div/>").css(g).css({
                            left: c + n * f,
                            top: c + e * f
                        }).appendTo(s);
                    return s
            ...
            var e, u = t.window,
                d = u.jQuery,
                f = !(!(e = u.document.createElement("canvas")).getContext || !e.getContext("2d")),
                s = {
                    render: "canvas",
                    minVersion: 1,
                    maxVersion: 40,
        ...
        var n, o, i, a = function() {
            function i(t, r) {
                ...
                var u = t,
                    ...
                    e = function(t, r) {
                        for (var e = -1; e <= 7; e += 1)
                            if (!(t + e <= -1 || g <= t + e))
                                for (var n = -1; n <= 7; n += 1) r + n <= -1 || g <= r + n || (l[t + e][r + n] = 0 <= e && e <= 6 && (0 == n || 6 == n) || 0 <= n && n <= 6 && (0 == e || 6 == e) || 2 <= e && e <= 4 && 2 <= n && n <= 4)
                    },
                    o = function() {
                    ...
                    i = function() {
                        for (var t = y.getPatternPosition(u), r = 0; r < t.length; r += 1)
                    ...
                    v = function(t, r) {
                        for (var e = -1, n = g - 1, o = 7, i = 0, a = y.getMaskFunction(r), u = g - 1; 0 < u; u -= 2)
                            for (6 == u && (u -= 1);;) {
                                for (var f = 0; f < 2; f += 1)
                                    if (null == l[n][u - f]) {
                                        var c = !1;
                    ...
                    p = function(t, r, e) {
                        ...
                        return function(t, r) {
                            for (var e = 0, n = 0, o = 0, i = new Array(r.length), a = new Array(r.length), u = 0; u < r.length; u += 1) {
                                ...
                                e += f;
                                var g = y.getErrorCorrectPolynomial(c),
                                    s = m(i[u], g.getLength() - 1).mod(g);
            ...
            var k, t, C = (k = [
                    ...
                    for (var n, o, i = e.length / 3, a = [], u = 0; u < i; u += 1)
                        for (var f = e[3 * u + 0], c = e[3 * u + 1], l = e[3 * u + 2], g = 0; g < f; g += 1) a.push((n = l, o = void 0, (o = {}).totalCount = c, o.dataCount = n, o));
                    return a
                }, t),
                B = function() {
                    var e = [],
